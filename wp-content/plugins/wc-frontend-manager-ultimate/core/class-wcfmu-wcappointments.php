...
class WCFMu_WCAppointments {
  ...
  function wcfm_appointment_gcal_user_profile() {
  	global $WCFM, $WCFMu;
		...
		?>
		<div class="page_collapsible wcfm_profile_manage_apt_gcal_sync" id="wcfm_profile_manage_form_apt_gcal_sync_head"><label class="wcfmfa fa-calendar"></label><?php _e( 'Google Calendar Sync', 'wc-frontend-manager-ultimate' ); ?><span></span></div>
