...
if( !current_user_can( 'edit_products' ) || !apply_filters( 'wcfm_is_pref_products_import', true ) || !$wcfm_is_allow_manage_products || !$wcfm_is_allow_add_products || !$wcfm_is_allow_products_import ) {
