<?php 
global $WCFM, $WCFMu, $wpo_wcpdf, $withdrawal_id, $document, $document_type, $wpdb; 
	  	...
	  	foreach( $wi_commission_ids as $wi_commission_id ) {
				...
				if( !empty( $orders_details ) ) {
					...
					<tr>
						...
						<?php } ?>
						<td style="text-align:center;"><?php echo wc_price( $order_details->total_commission, array( 'currency' => $order_currency ) ); ?></td>
					</tr>
					<?php
					}
				}
					...
					<tbody class="no-borders" style="float:right;">
					  <tr class="no-borders">
						...
						<tr class="no-borders">
							...
							<td style="text-align:right;font-weight:400;font-size:18px;padding-top:10px;"><strong><?php echo wc_price( $paid_amount, array( 'currency' => $pay_currency ) ); ?></strong></td>
						</tr>
					</tbody>
				</table>
			</td>
