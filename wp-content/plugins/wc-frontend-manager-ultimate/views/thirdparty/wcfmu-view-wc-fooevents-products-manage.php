...
if( isset( $wp->query_vars['wcfm-products-manage'] ) && !empty( $wp->query_vars['wcfm-products-manage'] ) ) {
	...
	if( $product && !empty($product) && is_object($product) ) {
      ...
      $fooevents_seating_options = json_decode($fooevents_seating_options_serialized, true);
		...
		if ( WCFMu_Dependencies::wcfm_wc_fooevents_tdfticket() ) {
	...
	<div id="wcfm_products_manage_form_wc_fooevents_expander" class="wcfm-content">
	  ...
	  <div id="woocommerce_events_data" class="panel woocommerce_options_panel">
        ...
        <?php if(!empty($product_id)) :?>
            ...
            <p class="form-field">
							...
							<select name="WooCommerceBadgeField1" id="WooCommerceBadgeField1" class="wcfm-select">
								...
								<option value="barcode" <?php echo ($WooCommerceBadgeField1 == 'barcode')? 'SELECTED' : ''; ?>><?php echo "Barcode"; ?></option>
								...
								<option value="seat" <?php echo ($WooCommerceBadgeField1 == 'seat')? 'SELECTED' : ''; ?>><?php echo "Attendee Seat"; ?></option>
							...
							<select name="WooCommerceBadgeField2" id="WooCommerceBadgeField2" class="wcfm-select">
								...
								<option value="barcode" <?php echo ($WooCommerceBadgeField2 == 'barcode')? 'SELECTED' : ''; ?>><?php echo "Barcode"; ?></option>
								...
								<option value="seat" <?php echo ($WooCommerceBadgeField2 == 'seat')? 'SELECTED' : ''; ?>><?php echo "Attendee Seat"; ?></option>
								<?php foreach( $cf_array as $key => $value) {
									echo '<option value="' . $key . '"';
							...
							<select name="WooCommerceBadgeField3" id="WooCommerceBadgeField3" class="wcfm-select">
								...
								<option value="barcode" <?php echo ($WooCommerceBadgeField3 == 'barcode')? 'SELECTED' : ''; ?>><?php echo "Barcode"; ?></option>
								...
								<option value="seat" <?php echo ($WooCommerceBadgeField3 == 'seat')? 'SELECTED' : ''; ?>><?php echo "Attendee Seat"; ?></option>
								<?php foreach( $cf_array as $key => $value) {
										echo '<option value="' . $key . '"';
          ...
          <div class="options_group">
            ...
            <p class="form-field">
							...
							<select name="WooCommercePrintTicketSize" id="WooCommercePrintTicketSize" class="wcfm-select">
								<option value="tickets_avery_letter_10"<?php echo ($WooCommercePrintTicketSize == 'tickets_avery_letter_10')? 'SELECTED' : ''; ?>><?php echo "10 tickets per sheet (Letter size)"; ?></option>
								<option value="tickets_letter_10"<?php echo ($WooCommercePrintTicketSize == 'tickets_letter_10')? 'SELECTED' : ''; ?>><?php echo "10 tickets per sheet 5.5in x 1.75in (Avery 16154 Tickets Letter size)"; ?></option>
								<option value="tickets_a4_10"<?php echo ($WooCommercePrintTicketSize == 'tickets_a4_10')? 'SELECTED' : ''; ?>><?php echo "10 tickets per sheet (A4 size)"; ?></option>
							</select>
            </p>
            ...
            <p class="form-field">
						 ...
						 <select name="WooCommercePrintTicketField1" id="WooCommercePrintTicketField1" class="wcfm-select">
								<option value="nothing" <?php echo ($WooCommercePrintTicketField1 == 'nothing')? 'SELECTED' : ''; ?>><?php echo "(Nothing)"; ?></option>
								<option value="barcode" <?php echo ($WooCommercePrintTicketField1 == 'barcode')? 'SELECTED' : ''; ?>><?php echo "Barcode"; ?></option>
								<option value="event" <?php echo ($WooCommercePrintTicketField1 == 'event')? 'SELECTED' : ''; ?>><?php echo "Event Name Only"; ?></option>
								<option value="event_var" <?php echo ($WooCommercePrintTicketField1 == 'event_var')? 'SELECTED' : ''; ?>><?php echo "Event Name and Variations"; ?></option>
								<option value="location" <?php echo ($WooCommercePrintTicketField1 == 'location')? 'SELECTED' : ''; ?>><?php echo "Location"; ?></option>
								<option value="ticketnr" <?php echo ($WooCommercePrintTicketField1 == 'ticketnr')? 'SELECTED' : ''; ?>><?php echo "Ticket Number"; ?></option>
								<option value="name" <?php echo ($WooCommercePrintTicketField1 == 'name')? 'SELECTED' : ''; ?>><?php echo "Attendee Name"; ?></option>
								<option value="seat" <?php echo ($WooCommercePrintTicketField1 == 'seat')? 'SELECTED' : ''; ?>><?php echo "Attendee Seat"; ?></option>
								<?php foreach( $cf_array as $key => $value) {
										echo '<option value="' . $key . '"';
							 ...
							 <select name="WooCommercePrintTicketField1_font" id="WooCommercePrintTicketField1_font" class="wcfm-select">
									<option value="small" <?php echo ($WooCommercePrintTicketField1_font == 'small')? 'SELECTED' : ''; ?>><?php echo "Small regular text"; ?></option>
									<option value="small_uppercase" <?php echo ($WooCommercePrintTicketField1_font == 'small_uppercase')? 'SELECTED' : ''; ?>><?php echo "Small uppercase text"; ?></option>
									<option value="medium" <?php echo ($WooCommercePrintTicketField1_font == 'medium')? 'SELECTED' : ''; ?>><?php echo "Medium regular text"; ?></option>
									<option value="medium_uppercase" <?php echo ($WooCommercePrintTicketField1_font == 'medium_uppercase')? 'SELECTED' : ''; ?>><?php echo "Medium uppercase text"; ?></option>
									<option value="large" <?php echo ($WooCommercePrintTicketField1_font == 'large')? 'SELECTED' : ''; ?>><?php echo "Large regular text"; ?></option>       
									<option value="large_uppercase" <?php echo ($WooCommercePrintTicketField1_font == 'large_uppercase')? 'SELECTED' : ''; ?>><?php echo "Large uppercase text"; ?></option>       
							 </select>
									
							 <span class="wcfm_title"><strong></span>
							 <select name="WooCommercePrintTicketField2" id="WooCommercePrintTicketField2" class="wcfm-select">
								<option value="nothing" <?php echo ($WooCommercePrintTicketField2 == 'nothing')? 'SELECTED' : ''; ?>><?php echo "(Nothing)"; ?></option>
								<option value="barcode" <?php echo ($WooCommercePrintTicketField2 == 'barcode')? 'SELECTED' : ''; ?>><?php echo "Barcode"; ?></option>
								<option value="event" <?php echo ($WooCommercePrintTicketField2 == 'event')? 'SELECTED' : ''; ?>><?php echo "Event Name Only"; ?></option>
								<option value="event_var" <?php echo ($WooCommercePrintTicketField2 == 'event_var')? 'SELECTED' : ''; ?>><?php echo "Event Name and Variations"; ?></option>
								<option value="location" <?php echo ($WooCommercePrintTicketField2 == 'location')? 'SELECTED' : ''; ?>><?php echo "Location"; ?></option>
								<option value="ticketnr" <?php echo ($WooCommercePrintTicketField2 == 'ticketnr')? 'SELECTED' : ''; ?>><?php echo "Ticket Number"; ?></option>
								<option value="name" <?php echo ($WooCommercePrintTicketField2 == 'name')? 'SELECTED' : ''; ?>><?php echo "Attendee Name"; ?></option>
								<option value="seat" <?php echo ($WooCommercePrintTicketField2 == 'seat')? 'SELECTED' : ''; ?>><?php echo "Attendee Seat"; ?></option>
								<?php foreach( $cf_array as $key => $value) {
										echo '<option value="' . $key . '"';
							 ...
							 <select name="WooCommercePrintTicketField2_font" id="WooCommercePrintTicketField2_font" class="wcfm-select">
								<option value="small" <?php echo ($WooCommercePrintTicketField2_font == 'small')? 'SELECTED' : ''; ?>><?php echo "Small regular text"; ?></option>
								<option value="small_uppercase" <?php echo ($WooCommercePrintTicketField2_font == 'small_uppercase')? 'SELECTED' : ''; ?>><?php echo "Small uppercase text"; ?></option>
								<option value="medium" <?php echo ($WooCommercePrintTicketField2_font == 'medium')? 'SELECTED' : ''; ?>><?php echo "Medium regular text"; ?></option>
								<option value="medium_uppercase" <?php echo ($WooCommercePrintTicketField2_font == 'medium_uppercase')? 'SELECTED' : ''; ?>><?php echo "Medium uppercase text"; ?></option>
								<option value="large" <?php echo ($WooCommercePrintTicketField2_font == 'large')? 'SELECTED' : ''; ?>><?php echo "Large regular text"; ?></option>       
								<option value="large_uppercase" <?php echo ($WooCommercePrintTicketField2_font == 'large_uppercase')? 'SELECTED' : ''; ?>><?php echo "Large uppercase text"; ?></option>
							 </select>
							
							 <span class="wcfm_title"><strong></span>
							 <select name="WooCommercePrintTicketField3" id="WooCommercePrintTicketField3" class="wcfm-select">
								<option value="nothing" <?php echo ($WooCommercePrintTicketField3 == 'nothing')? 'SELECTED' : ''; ?>><?php echo "(Nothing)"; ?></option>
								<option value="barcode" <?php echo ($WooCommercePrintTicketField3 == 'barcode')? 'SELECTED' : ''; ?>><?php echo "Barcode"; ?></option>
								<option value="event" <?php echo ($WooCommercePrintTicketField3 == 'event')? 'SELECTED' : ''; ?>><?php echo "Event Name Only"; ?></option>
								<option value="event_var" <?php echo ($WooCommercePrintTicketField3 == 'event_var')? 'SELECTED' : ''; ?>><?php echo "Event Name and Variations"; ?></option>
								<option value="location" <?php echo ($WooCommercePrintTicketField3 == 'location')? 'SELECTED' : ''; ?>><?php echo "Location"; ?></option>
								<option value="ticketnr" <?php echo ($WooCommercePrintTicketField3 == 'ticketnr')? 'SELECTED' : ''; ?>><?php echo "Ticket Number"; ?></option>
								<option value="name" <?php echo ($WooCommercePrintTicketField3 == 'name')? 'SELECTED' : ''; ?>><?php echo "Attendee Name"; ?></option>
								<option value="seat" <?php echo ($WooCommercePrintTicketField3 == 'seat')? 'SELECTED' : ''; ?>><?php echo "Attendee Seat"; ?></option>
								<?php foreach( $cf_array as $key => $value) {
										echo '<option value="' . $key . '"';
							...
							<span class="wcfm_title"><strong></span>
							 <select name="WooCommercePrintTicketField3_font" id="WooCommercePrintTicketField3_font" class="wcfm-select">
								<option value="small" <?php echo ($WooCommercePrintTicketField3_font == 'small')? 'SELECTED' : ''; ?>><?php echo "Small regular text"; ?></option>
								<option value="small_uppercase" <?php echo ($WooCommercePrintTicketField3_font == 'small_uppercase')? 'SELECTED' : ''; ?>><?php echo "Small uppercase text"; ?></option>
								<option value="medium" <?php echo ($WooCommercePrintTicketField3_font == 'medium')? 'SELECTED' : ''; ?>><?php echo "Medium regular text"; ?></option>
								<option value="medium_uppercase" <?php echo ($WooCommercePrintTicketField3_font == 'medium_uppercase')? 'SELECTED' : ''; ?>><?php echo "Medium uppercase text"; ?></option>
								<option value="large" <?php echo ($WooCommercePrintTicketField3_font == 'large')? 'SELECTED' : ''; ?>><?php echo "Large regular text"; ?></option>       
								<option value="large_uppercase" <?php echo ($WooCommercePrintTicketField3_font == 'large_uppercase')? 'SELECTED' : ''; ?>><?php echo "Large uppercase text"; ?></option>
							 </select>
							...
							<select name="WooCommercePrintTicketField4" id="WooCommercePrintTicketField4" class="wcfm-select">
								<option value="nothing" <?php echo ($WooCommercePrintTicketField4 == 'nothing')? 'SELECTED' : ''; ?>><?php echo "(Nothing)"; ?></option>
								<option value="barcode" <?php echo ($WooCommercePrintTicketField4 == 'barcode')? 'SELECTED' : ''; ?>><?php echo "Barcode"; ?></option>
								<option value="event" <?php echo ($WooCommercePrintTicketField4 == 'event')? 'SELECTED' : ''; ?>><?php echo "Event Name Only"; ?></option>
								<option value="event_var" <?php echo ($WooCommercePrintTicketField4 == 'event_var')? 'SELECTED' : ''; ?>><?php echo "Event Name and Variations"; ?></option>
								<option value="location" <?php echo ($WooCommercePrintTicketField4 == 'location')? 'SELECTED' : ''; ?>><?php echo "Location"; ?></option>
								<option value="ticketnr" <?php echo ($WooCommercePrintTicketField4 == 'ticketnr')? 'SELECTED' : ''; ?>><?php echo "Ticket Number"; ?></option>
								<option value="name" <?php echo ($WooCommercePrintTicketField4 == 'name')? 'SELECTED' : ''; ?>><?php echo "Attendee Name"; ?></option>
								<option value="seat" <?php echo ($WooCommercePrintTicketField4 == 'seat')? 'SELECTED' : ''; ?>><?php echo "Attendee Seat"; ?></option>
								<?php foreach( $cf_array as $key => $value) {
										echo '<option value="' . $key . '"';
							...
							<select name="WooCommercePrintTicketField4_font" id="WooCommercePrintTicketField4_font" class="wcfm-select">
								<option value="small" <?php echo ($WooCommercePrintTicketField4_font == 'small')? 'SELECTED' : ''; ?>><?php echo "Small regular text"; ?></option>
								<option value="small_uppercase" <?php echo ($WooCommercePrintTicketField4_font == 'small_uppercase')? 'SELECTED' : ''; ?>><?php echo "Small uppercase text"; ?></option>
								<option value="medium" <?php echo ($WooCommercePrintTicketField4_font == 'medium')? 'SELECTED' : ''; ?>><?php echo "Medium regular text"; ?></option>
								<option value="medium_uppercase" <?php echo ($WooCommercePrintTicketField4_font == 'medium_uppercase')? 'SELECTED' : ''; ?>><?php echo "Medium uppercase text"; ?></option>
								<option value="large" <?php echo ($WooCommercePrintTicketField4_font == 'large')? 'SELECTED' : ''; ?>><?php echo "Large regular text"; ?></option>       
								<option value="large_uppercase" <?php echo ($WooCommercePrintTicketField4_font == 'large_uppercase')? 'SELECTED' : ''; ?>><?php echo "Large uppercase text"; ?></option>
							</select>
							
							<span class="wcfm_title"><strong></span>
							<select name="WooCommercePrintTicketField5" id="WooCommercePrintTicketField5" class="wcfm-select">
								<option value="nothing" <?php echo ($WooCommercePrintTicketField5 == 'nothing')? 'SELECTED' : ''; ?>><?php echo "(Nothing)"; ?></option>
								<option value="barcode" <?php echo ($WooCommercePrintTicketField5 == 'barcode')? 'SELECTED' : ''; ?>><?php echo "Barcode"; ?></option>
								<option value="event" <?php echo ($WooCommercePrintTicketField5 == 'event')? 'SELECTED' : ''; ?>><?php echo "Event Name Only"; ?></option>
								<option value="event_var" <?php echo ($WooCommercePrintTicketField5 == 'event_var')? 'SELECTED' : ''; ?>><?php echo "Event Name and Variations"; ?></option>
								<option value="location" <?php echo ($WooCommercePrintTicketField5 == 'location')? 'SELECTED' : ''; ?>><?php echo "Location"; ?></option>
								<option value="ticketnr" <?php echo ($WooCommercePrintTicketField5 == 'ticketnr')? 'SELECTED' : ''; ?>><?php echo "Ticket Number"; ?></option>
								<option value="name" <?php echo ($WooCommercePrintTicketField5 == 'name')? 'SELECTED' : ''; ?>><?php echo "Attendee Name"; ?></option>
								<option value="seat" <?php echo ($WooCommercePrintTicketField5 == 'seat')? 'SELECTED' : ''; ?>><?php echo "Attendee Seat"; ?></option>
								<?php foreach( $cf_array as $key => $value) {
										echo '<option value="' . $key . '"';
							...
							<select name="WooCommercePrintTicketField5_font" id="WooCommercePrintTicketField5_font" class="wcfm-select">
								<option value="small" <?php echo ($WooCommercePrintTicketField5_font == 'small')? 'SELECTED' : ''; ?>><?php echo "Small regular text"; ?></option>
								<option value="small_uppercase" <?php echo ($WooCommercePrintTicketField5_font == 'small_uppercase')? 'SELECTED' : ''; ?>><?php echo "Small uppercase text"; ?></option>
								<option value="medium" <?php echo ($WooCommercePrintTicketField5_font == 'medium')? 'SELECTED' : ''; ?>><?php echo "Medium regular text"; ?></option>
								<option value="medium_uppercase" <?php echo ($WooCommercePrintTicketField5_font == 'medium_uppercase')? 'SELECTED' : ''; ?>><?php echo "Medium uppercase text"; ?></option>
								<option value="large" <?php echo ($WooCommercePrintTicketField5_font == 'large')? 'SELECTED' : ''; ?>><?php echo "Large regular text"; ?></option>       
								<option value="large_uppercase" <?php echo ($WooCommercePrintTicketField5_font == 'large_uppercase')? 'SELECTED' : ''; ?>><?php echo "Large uppercase text"; ?></option>
							</select>
							
							<span class="wcfm_title"><strong></span>
							<select name="WooCommercePrintTicketField6" id="WooCommercePrintTicketField6" class="wcfm-select">
								<option value="nothing" <?php echo ($WooCommercePrintTicketField6 == 'nothing')? 'SELECTED' : ''; ?>><?php echo "(Nothing)"; ?></option>
								<option value="barcode" <?php echo ($WooCommercePrintTicketField6 == 'barcode')? 'SELECTED' : ''; ?>><?php echo "Barcode"; ?></option>
								<option value="event" <?php echo ($WooCommercePrintTicketField6 == 'event')? 'SELECTED' : ''; ?>><?php echo "Event Name Only"; ?></option>
								<option value="event_var" <?php echo ($WooCommercePrintTicketField6 == 'event_var')? 'SELECTED' : ''; ?>><?php echo "Event Name and Variations"; ?></option>
								<option value="location" <?php echo ($WooCommercePrintTicketField6 == 'location')? 'SELECTED' : ''; ?>><?php echo "Location"; ?></option>
								<option value="ticketnr" <?php echo ($WooCommercePrintTicketField6 == 'ticketnr')? 'SELECTED' : ''; ?>><?php echo "Ticket Number"; ?></option>
								<option value="name" <?php echo ($WooCommercePrintTicketField6 == 'name')? 'SELECTED' : ''; ?>><?php echo "Attendee Name"; ?></option>
								<option value="seat" <?php echo ($WooCommercePrintTicketField6 == 'seat')? 'SELECTED' : ''; ?>><?php echo "Attendee Seat"; ?></option>
								<?php foreach( $cf_array as $key => $value) {
										echo '<option value="' . $key . '"';
							...
							<select name="WooCommercePrintTicketField6_font" id="WooCommercePrintTicketField6_font" class="wcfm-select">
								<option value="small" <?php echo ($WooCommercePrintTicketField6_font == 'small')? 'SELECTED' : ''; ?>><?php echo "Small regular text"; ?></option>
								<option value="small_uppercase" <?php echo ($WooCommercePrintTicketField6_font == 'small_uppercase')? 'SELECTED' : ''; ?>><?php echo "Small uppercase text"; ?></option>
								<option value="medium" <?php echo ($WooCommercePrintTicketField6_font == 'medium')? 'SELECTED' : ''; ?>><?php echo "Medium regular text"; ?></option>
								<option value="medium_uppercase" <?php echo ($WooCommercePrintTicketField6_font == 'medium_uppercase')? 'SELECTED' : ''; ?>><?php echo "Medium uppercase text"; ?></option>
								<option value="large" <?php echo ($WooCommercePrintTicketField6_font == 'large')? 'SELECTED' : ''; ?>><?php echo "Large regular text"; ?></option>       
								<option value="large_uppercase" <?php echo ($WooCommercePrintTicketField6_font == 'large_uppercase')? 'SELECTED' : ''; ?>><?php echo "Large uppercase text"; ?></option>
							</select>
        ...
        <?php if ( WCFMu_Dependencies::wcfm_wc_fooevents_seating() ) { ?>
        	   ...
        	   <div class="wcfm-clearfix"></div><br />
						 <div class="options_group">
							 ...
							 <table id="fooevents_seating_options_table" cellpadding="0" cellspacing="0">
									<thead>
										<tr>
											<th>Area Name (e.g. Row 1, Table 1, etc.)</th>
											<th>Available Seats / Spaces</th>
											<th>Variation</th>
											<th></th>
										</tr>
									</thead>
          ...
          <?php if ( WCFMu_Dependencies::wcfm_wc_fooevents_tdfticket() ) { ?>
