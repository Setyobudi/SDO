	...
	<form method="get" id="mainform" enctype="multipart/form-data" class="wc_appointments_calendar_form day_view">
		...
		<div class="tablenav">
			...
			<div class="date_selector">
				<a class="prev wcfmfa fa-arrow-circle-left" href="<?php echo esc_url( add_query_arg( 'calendar_day', $prev_day ) ); ?>"></a>
				...
				<a class="next wcfmfa fa-arrow-circle-right" href="<?php echo esc_url( add_query_arg( 'calendar_day', $next_day ) ); ?>"></a>
			</div>
			<div class="views">
