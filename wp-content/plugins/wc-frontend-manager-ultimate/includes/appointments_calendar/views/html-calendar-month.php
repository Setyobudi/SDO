	...
	<form method="get" id="mainform" enctype="multipart/form-data" class="wc_appointments_calendar_form month_view">
		...
		<div class="tablenav">
			...
			<div class="date_selector">
				<a class="prev wcfmfa fa-arrow-circle-left" href="<?php echo esc_url( add_query_arg( array( 'calendar_year' => $year, 'calendar_month' => $month - 1 ) ) ); ?>"></a>
				...
				<a class="next wcfmfa fa-arrow-circle-right" href="<?php echo esc_url( add_query_arg( array( 'calendar_year' => $year, 'calendar_month' => $month + 1 ) ) ); ?>"></a>
			</div>
			<div class="views">
