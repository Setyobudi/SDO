	...
	<form method="get" id="mainform" enctype="multipart/form-data" class="wc_appointments_calendar_form week_view">
		...
		<div class="tablenav">
			...
			<div class="week_selector date_selector">
				<a class="prev wcfmfa fa-arrow-circle-left" href="<?php echo esc_url( add_query_arg( 'calendar_day', $prev_week ) ); ?>"></a>
				...
				<a class="next wcfmfa fa-arrow-circle-right" href="<?php echo esc_url( add_query_arg( 'calendar_day', $next_week ) ); ?>"></a>
			</div>
			<div class="views">
